...
from core.indicator_manager.vegitation_indicator.ladnsat_8_ndvi import Landsat8Ndvi
from core.indicator_manager.vegitation_indicator.modis_ndvi import ModisNdvi
...
INDICATOR_REGISTRY: dict[str, type[BaseIndicator]] = {
    ...
    "NDSI_LANDSAT_8":Landsat8NDSI,  # Placeholder for NDSI indicator
}